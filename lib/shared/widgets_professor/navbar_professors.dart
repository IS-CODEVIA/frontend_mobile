      ...
      child: SafeArea(
        child: Column(
          ...
          children: [
            ...
            _buildMenuItem('Asignaturas', Icons.menu_book_rounded, itemStyle, () => context.goNamed('professor-home')),
            const SizedBox(height: 16),
            _buildMenuItem('Archivadas', Icons.archive_outlined, itemStyle, () => context.goNamed('professor-archived')),
            const Spacer(),
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  _buildMenuItem('Configuracion', Icons.settings_outlined, itemStyle, () => context.goNamed('professor-settings')),
                  const SizedBox(height: 16),
